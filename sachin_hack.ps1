...
Write-Host "`n==== REPORT COMPLETE ====" -ForegroundColor DarkGreen

Write-Host ""
Type-Effect "Hello Jyoti Industries Employee you are in my control 😂" DarkGreen
Type-Effect "All your files are encrypted now by Hackers Group or Black Hat Hackers 😂" DarkGreen
Type-Effect "It is a Ransomeware attack on your system all files are encrypted !!!! 😄" DarkGreen
Type-Effect "It is a Ransomeware attack on your system all files are encrypted !!!! 😄" DarkGreen
...
Write-Host ""
Write-Host "Press any key to exit..." -ForegroundColor DarkGreen
